...
(function () {
  ...
  function installStyle() {
    ...
    s.id = STYLE_ID;
    s.textContent = `
      .dist-note-wrap{display:flex;justify-content:center;margin:5px 0 2px}
      .dist-note-button{border:1px solid rgba(56,189,248,.22);background:rgba(15,23,42,.58);color:#bae6fd;border-radius:999px;padding:5px 10px;font-size:10.5px;font-weight:750;letter-spacing:.03em;cursor:pointer}
      body.light-mode .dist-note-button{background:rgba(248,250,252,.84);color:#075985;border-color:rgba(14,165,233,.26)}
      ...
      .dist-note-dialog{width:min(430px,94vw);border-radius:20px;border:1px solid rgba(56,189,248,.26);background:linear-gradient(180deg,rgba(15,23,42,.97),rgba(2,6,23,.96));box-shadow:0 28px 90px rgba(0,0,0,.62),inset 0 1px 0 rgba(255,255,255,.05);padding:16px;color:#e5e7eb}
