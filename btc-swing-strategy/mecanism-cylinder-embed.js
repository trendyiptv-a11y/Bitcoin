(function () {
  ...
  const T = {
    ro: {
      ...
      signal: "SEMNAL", asset: "BTC", legendTitle: "LEGENDĂ SEMNALE",
    ...
    en: {
      ...
      signal: "SIGNAL", asset: "BTC", legendTitle: "SIGNAL LEGEND",
  ...
  function derive(data) {
    ...
    const info = {
      ...
      formula: compact(r.formula || pick(data, "formula", "formula_en") || pick(data, "plain_language", "plain_language_en") || pick(data, "summary", "summary_en") || data?.message),
      ...
      <div class="cxdc">
        <div class="cxdc-core">
          <div class="cxdc-labels">
            <div class="cxdc-label context"><div class="k">${T[l].context}</div><div class="v">${escHtml(info.context)}</div></div>
            <div class="cxdc-label price"><div class="k">${T[l].price}</div><div class="v">${escHtml(info.price)}</div></div>
            <div class="cxdc-label part"><div class="k">${T[l].participation}</div><div class="v">${escHtml(info.participation)}</div></div>
            <div class="cxdc-label flow"><div class="k">${T[l].flow}</div><div class="v">${escHtml(info.flow)}</div></div>
            <div class="cxdc-label liq"><div class="k">${T[l].liquidity}</div><div class="v">${escHtml(info.liquidity)}</div></div>
            <div class="cxdc-label growth"><div class="k">${T[l].growth}</div><div class="v">${escHtml(info.growth)}</div></div>
            <div class="cxdc-label risk"><div class="k">${T[l].risk}</div><div class="v">${escHtml(info.risk)}</div></div>
          </div>
          <div class="cxdc-cylinder"><div class="cxdc-grid"></div><div class="cxdc-beam"></div><div class="cxdc-layer context"></div><div class="cxdc-layer price"></div><div class="cxdc-layer part"></div><div class="cxdc-layer flow"></div><div class="cxdc-layer liq"></div><div class="cxdc-layer growth"></div><div class="cxdc-off" style="display:${info.visual.growthPresent ? "none" : "block"}">⊘</div><div class="cxdc-risk" style="opacity:${info.visual.riskReduced ? ".55" : ".98"}"></div></div>
        </div>
