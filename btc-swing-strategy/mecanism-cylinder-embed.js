(function () {
  ...
  function css() {
    ...
    style.textContent = `
      ...
      .cxdc-particles{position:absolute;inset:0;opacity:.30;background-image:radial-gradient(circle,rgba(125,250,255,.92) 1px,transparent 1.8px);background-size:22px 22px;animation:cxdcParticles 10s linear infinite}.cxdc-grid{position:absolute;inset:18px 10px;border-radius:26px;background:linear-gradient(90deg,rgba(200,240,255,.055) 1px,transparent 1px),linear-gradient(180deg,rgba(200,240,255,.045) 1px,transparent 1px);background-size:22px 22px;opacity:.45}
      ...
      .cxdc-layer{position:absolute;left:17px;right:17px;height:46px;border-radius:50%;border:2px solid var(--c);background:radial-gradient(ellipse at center,color-mix(in srgb,var(--c) 22%,transparent),transparent 70%);box-shadow:0 0 24px var(--c),inset 0 0 18px rgba(255,255,255,.12);animation:cxdcFloat 4.4s ease-in-out infinite;z-index:4}.cxdc-layer:before{content:"";position:absolute;left:12%;right:12%;top:50%;height:2px;background:var(--c);box-shadow:0 0 10px var(--c)}
      .cxdc-layer.context{top:66px;--c:#f8feff}.cxdc-layer.price{top:132px;--c:#ffe600}.cxdc-layer.part{top:198px;--c:#ff9800}.cxdc-layer.flow{top:264px;--c:#14f4ff}.cxdc-layer.liq{top:330px;--c:#19a7ff}.cxdc-layer.growth{top:396px;--c:#ff4968}.cxdc-risk{position:absolute;left:30px;right:30px;bottom:34px;height:54px;border-radius:50%;border:2px solid #ff4c25;background:radial-gradient(ellipse at center,rgba(255,75,32,.62),transparent 72%);box-shadow:0 0 34px rgba(255,88,40,.85);z-index:5;animation:cxdcRisk 3.2s ease-in-out infinite}.cxdc-off{position:absolute;left:50%;top:412px;transform:translateX(-50%);font-size:40px;color:#ff3156;text-shadow:0 0 16px #ff3156;z-index:7}
