...
def _compute_structural_position(
    model_price: Optional[float],
    spot_price: Optional[float],
) -> Tuple[Optional[StructuralPosition], Optional[float]]:
...
def classify_structural_regime(
    ...
    if (
        ...
        return StructuralRegime(
            ...
            description=(
                "Sub model, presiune de vânzare și lichiditate scăzută – "
                "mișcările sunt amplificate de absența market makerilor."
            ),
        )
    ...
    if (
        ...
        return StructuralRegime(
            ...
            description=(
                "Sub model, vânzare în condiții de lichiditate cel puțin moderată – "
                "piața acceptă niveluri mai joase."
            ),
        )
    ...
    if (
        ...
        return StructuralRegime(
            ...
            label="Piață inertă",
            description=(
                "Sub model, flux echilibrat și lichiditate redusă – "
                "lipsă de apetit clar pentru direcție."
            ),
        )
    ...
    if (
        ...
        return StructuralRegime(
            ...
            description=(
                "BTC este la nivelul modelului, fluxul este relativ echilibrat, "
                "iar lichiditatea este confortabilă."
            ),
        )
    ...
    if (
        ...
        return StructuralRegime(
            ...
            description=(
                "La model, cumpărare în regim de lichiditate ridicată – "
                "interes real, dar fără grabă."
            ),
        )
    ...
    if (
        ...
        return StructuralRegime(
            ...
            description=(
                "Peste model, cumpărare în condiții de lichiditate ridicată – "
                "momentum susținut într-o piață elastică."
            ),
        )
    ...
    if (
        ...
        return StructuralRegime(
            ...
            description=(
                "Peste model, cumpărare într-o piață subțire – "
                "raliu rapid, dar instabil."
            ),
        )
    ...
    if (
        ...
        return StructuralRegime(
            ...
            description=(
                "Peste model, vânzare în lichiditate scăzută – "
                "distribuție sau schimbare de comportament al pieței."
            ),
        )
...
try:
    ...
    def compute_flow_from_daily_csv(path: str = os.path.join("data", "btc_daily.csv")) -> Dict[str, Any]:
        return {
            "bias": None,
            "strength": None,
            "flow_value": None,
...
try:
    ...
    def compute_liquidity_from_daily_csv(path: str = os.path.join("data", "btc_daily.csv")) -> Dict[str, Any]:
        return {
            "regime": None,
            "strength": None,
...
def main() -> None:
    ...
    # regim dinamic (trend + deviație)
    market_regime = classify_market_regime(last, dev_pct_model)

    # Flow
    try:
        flow_raw = compute_flow_from_daily_csv()
        flow = {
            "flow_score": flow_raw.get("flow_value"),
    ...
    try:
        ...
        liq = {
            "liquidity_score": liq_raw.get("liquidity_value"),
    ...
    # regim structural standard (8 situații)
    ...
    state: Dict[str, Any] = {
        ...
        # regim dinamic (trend + model)
        "market_regime": market_regime,

        # regim structural (8 situații)
    ...
    print("Regim piață (dinamic):", market_regime)
    print("Regim structural (8 situații):", {
        "id": state.get("market_regime_id"),
        "key": state.get("market_regime_key"),
    })
    print(
        "Flow bias:", flow.get("flow_bias"),
        "| Flow strength:", flow.get("flow_strength"),
    )
    print(
        "Liquidity regime:", liq.get("liquidity_regime"),
        "| Liquidity strength:", liq.get("liquidity_strength"),
    )
