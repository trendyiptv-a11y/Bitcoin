...
from cohesivx_projection_engine import (
    PROJECTION_END_YEAR,
    PROJECTION_START_YEAR,
    build_10y_structural_projection,
)
...
def main() -> None:
    ...
    projection = build_10y_structural_projection(state)
    ...
    print("10Y projection engine:", (projection or {}).get("engine"))
